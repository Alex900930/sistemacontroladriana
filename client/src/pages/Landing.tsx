...
export default function Landing() {
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              {/* CAMBIO: Link directo al dashboard en lugar de /api/login */}
              <Link href="/dashboard">
                <Button variant="ghost" className="font-medium text-slate-600 hover:text-blue-600 cursor-pointer">
                  Entrar
                </Button>
              </Link>
              <Link href="/dashboard">
                <Button className="bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-600/20 rounded-full px-6 cursor-pointer">
                  Começar Grátis
                </Button>
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-in slide-in-from-left duration-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              {/* CAMBIO: Botón principal ahora usa Link para navegar internamente */}
              <Link href="/dashboard">
                <Button size="lg" className="h-14 px-8 text-lg rounded-full bg-blue-600 hover:bg-blue-700 shadow-xl shadow-blue-600/25 cursor-pointer">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Seus datos e de seus clientes protegidos com criptografia de ponta a ponta."
              },
              {
                icon: Building2,
      ...
      {/* Footer */}
      <footer className="text-center text-sm text-gray-500 py-8 border-t border-slate-100 mt-16">
        © 2026 ImobiERP. Todos os direitos reservados.<br />
        Desenvolvido por Alex Herrera 2026
      </footer>
    </div>
  );
}